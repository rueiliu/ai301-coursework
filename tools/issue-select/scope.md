...
I work mainly in Python and SQL, so far on the data-analysis side: pandas,
notebooks, querying and reshaping datasets. I am comfortable reading and
changing Python, and comfortable with SQL schemas and queries.

What I want out of this course is engineering practice rather than more
analysis: backend work, CLIs, data handling, tests, build and packaging
scripts. Rank Python backend and tooling issues highest, and treat an issue
with a runnable reproduction or an existing test I can extend as a better
fit than one without.

I want to avoid frontend work: UI layout, CSS, styling, visual-design
tweaks, and browser-rendering bugs. Rank those lowest even when my rubric
accepts them.
